    ...
    return(
        ...
        <div className="finance-hero">
            ...
            <div className="finance-hero-content">
                ...
                <a href="https://apply.acima.com/?utm_source=web&utm_medium=merchant&merchant_guid=merc-96d27a68-1a54-4854-941b-a09acc476ffe" className="primary-button button acima-button">
                    <span>Apply Now!</span>
                </a>
        </div>
        </div>
